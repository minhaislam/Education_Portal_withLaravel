...
@endsection
	...
	<div class="inner">
       ...
       <h3>Delete Info</h3>
          ...
          <div class="">
            Full Name:<input type="text" name="Full_Name" value="{{$admin->Full_Name}}" class="">
            <i class="zmdi zmdi-account"></i>
          </div>
          <div class="">
            User ID:<input type="text" readonly name="user_id"  value="{{$admin->user_id}}" class="">
            <i class="zmdi zmdi-id"></i>
          </div>
         
          <div class="">
           Password: <input type="password" name="password" value="{{$admin->password}}"  class="">
            <i class="zmdi zmdi-lock"></i>
          </div>
          <div class="">
           Type: <input type="text" name="type" value="{{$admin->type}}" class="">
          ...
          <div class="">
            ID:<input type="text" readonly name="id" value="{{$admin->id}}" placeholder="Full Name" class="">
            <i class="zmdi zmdi-account"></i>
          </div>
          <button>Delete
