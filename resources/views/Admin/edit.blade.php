        ...
        <form method="post">
          ...
          <input type="hidden" name="_token" value="{{csrf_token()}}">
           <div class="form-wrapper">
            ID:<input type="text" readonly name="id" value="{{$admin->id}}" placeholder="Full Name" class="form-control">
            <i class="zmdi zmdi-account"></i>
          </div>
          
          <div class="form-wrapper">
            Full Name:<input type="text" name="Full_Name" value="{{$admin->Full_Name}}" class="form-control">
            <i class="zmdi zmdi-account"></i>
          </div>
          <div class="form-wrapper">
            User ID:<input type="text" readonly name="user_id"  value="{{$admin->user_id}}" class="form-control">
            <i class="zmdi zmdi-id"></i>
          </div>
         
          <div class="form-wrapper">
           Password: <input type="password" name="password" value="{{$admin->password}}"  class="form-control">
            <i class="zmdi zmdi-lock"></i>
          </div>
          <div class="form-wrapper">
           Type: <input type="text" name="type" value="{{$admin->type}}" class="form-control">
